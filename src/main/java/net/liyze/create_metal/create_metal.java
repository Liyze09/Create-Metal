...
public class create_metal implements ModInitializer {
    ...
    public static BlockItem Raw_Tin_Block_Item;
    static {
    ...
    static {
        OVERWORLD_Tin_ORE_PLACED_FEATURE = new PlacedFeature(RegistryEntry.of(OVERWORLD_Tin_ORE_CONFIGURED_FEATURE), Arrays.asList(CountPlacementModifier.of(20), SquarePlacementModifier.of(), HeightRangePlacementModifier.uniform(YOffset.getBottom(), YOffset.fixed(128))));}
    @Override
    public void onInitialize(){
        ...
        //Tin Deepslate Ore
        Registry.register(Registry.BLOCK,new Identifier(
                "create_metal","deepslate_tin_ore"),Tin_Deep_Ore_Block);
        Registry.register(Registry.ITEM,new Identifier(
